...
import com.github.ecc1esia.backend.manager.websocket.disruptor.PictureEditEventProducer;
import com.github.ecc1esia.backend.manager.websocket.model.PictureEditActionEnum;
...
public class PictureEditHandler extends TextWebSocketHandler {
    ...
    public void afterConnectionEstablished(WebSocketSession session) throws Exception {
        ...
        String message = String.format("用户 %s 加入编辑图片", user.getUserName());
    ...
    protected void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
        ...
        // 获取消息,json转换为 PictureEditRequestMessage
