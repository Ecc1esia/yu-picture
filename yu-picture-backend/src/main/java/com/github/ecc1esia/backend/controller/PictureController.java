...
import com.github.ecc1esia.backend.api.aliyunai.model.GetOutPaintingTaskResponse;
import com.github.ecc1esia.backend.api.imagesearch.ImageSearchApiFacade;
...
import com.github.ecc1esia.backend.model.vo.PictureTagCategory;
...
//    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
     ...
     * @return BaseResponse<CreateOutPaintingTaskResponse> 返回创建的任务结果
     */
     ...
     *
     * @param taskId 任务ID
     * @return BaseResponse<GetOutPaintingTaskResponse> 返回查询到的任务结果
     */
