...
//    private FileManager fileManager;
    ...
    private static final String PUBLIC_UPLOAD_PATH_PREFIX = "public/%s";
    private static final String SPACE_UPLOAD_PATH_PREFIX = "space/%s";
    ...
    public PictureVO uploadPicture(Object inputSource, PictureUploadRequest pictureUploadRequest, User loginUser) {
        ...
        // 判断是新增还是删除
        Long pictureId = pictureUploadRequest.getId() == null ? null : pictureUploadRequest.getId();
        // 如果是更新，判断图片是否存在
        if (pictureId != null) {
    ...
    private void fillPictureWithNameRule(List<Picture> pictureList, String nameRule) {
        ...
        try {
            for (Picture picture : pictureList) {
                String pictureName = nameRule.replaceAll("\\{序号}", String.valueOf(current++));
