...
export async function searchVectorByUpload(
  ...
  return request<API.BaseResponseListVectorSearchResultVO_>('/api/picture/search/vector/by-upload', {
    method: 'POST',
    data: formData,
    headers: {
...
export async function searchVectorByPicture(
  ...
  return request<API.BaseResponseListVectorSearchResultVO_>('/api/picture/search/vector/by-picture', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** reindexAllPictures POST /api/picture/search/vector/reindex */
export async function reindexAllPictures(
  spaceId: number,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseString_>('/api/picture/search/vector/reindex', {
    method: 'POST',
    params: {
      spaceId,
    },
